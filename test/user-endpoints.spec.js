    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'aon', translation: 'one' },
            { original: 'dhà', translation: 'two' },
            { original: 'trì', translation: 'three' },
            { original: 'ceithir', translation: 'four' },
            { original: 'còig', translation: 'five' },
            { original: 'sia', translation: 'six' },
            { original: 'seachd', translation: 'seven' },
            { original: 'ochd', translation: 'eight' },
            { original: 'naoi', translation: 'nine' },
            { original: 'deich', translation: 'ten' },
            { original: 'alba', translation: 'scotland' },
            { original: 'uisge', translation: 'water' },
            { original: 'uisge-beatha', translation: 'whisky' },
            { original: 'cofaidh', translation: 'coffee' },
            { original: 'tì', translation: 'tea' },
            { original: 'agus', translation: 'and' },
            { original: 'dubh', translation: 'black' },
            { original: 'geal', translation: 'white' },
            { original: 'slàinte', translation: 'cheers' }
          ]
        };
        return supertest(app)
          .post('/api/user')
